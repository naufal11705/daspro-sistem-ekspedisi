...
public class Main {
    ...
    static String[][] languageModule = {
        ...
        {"","⚠️ PANJANG HARUS LEBIH BESAR DARI 0 . SILAHKAN COBA LAGI."},//115
        {"",""}
    ...
    private static void ManageTransaction() {
        ...
        switch (subMenu) {
            ...
            displayIndonesianMap();
                ...
                do {
                    ...
                    if (berat <= 0) {
                        ...
                        System.out.println("╠══════════════════════════════════════════════════════════════════════════════════════════════════╣");
                        System.out.println("║                                                                                                  ║");
                        System.out.println("║"+centerString(99, "⚠️ BERAT HARUS LEBIH BESAR DARI 0 . SILAHKAN COBA LAGI.")+"║");
                        System.out.println("║                                                                                                  ║");
                        System.out.println("╚══════════════════════════════════════════════════════════════════════════════════════════════════╝");
                        System.out.print(languageModule[81][selectedLanguage]);
                        input.nextLine();  
                ...
                do {
                    ...
                    if (luas <= 0) {
                        ...
                        System.out.println("╠══════════════════════════════════════════════════════════════════════════════════════════════════╣");
                        System.out.println("║                                                                                                  ║");
                        System.out.println("║"+centerString(99, "⚠️ LEBAR HARUS LEBIH BESAR DARI 0. SILAHKAN COBA LAGI.")+"║");
                        System.out.println("║                                                                                                  ║");
                        System.out.println("╚══════════════════════════════════════════════════════════════════════════════════════════════════╝");
                        System.out.print(languageModule[81][selectedLanguage]);
                        input.nextLine();  
                ...
                do {
                    ...
                    if (tinggi <= 0) {
                        ...
                        System.out.println("╠══════════════════════════════════════════════════════════════════════════════════════════════════╣");
                        System.out.println("║                                                                                                  ║");
                        System.out.println("║"+centerString(99, "⚠️ TINGGI HARUS LEBIH BESAR DARI 0. SILAHKAN COBA LAGI.")+"║");
                        System.out.println("║                                                                                                  ║");
                        System.out.println("╚══════════════════════════════════════════════════════════════════════════════════════════════════╝");
                        System.out.print(languageModule[81][selectedLanguage]);
                        input.nextLine();  
                ...
                do {
                    ...
                    if(!found) {
                        ...
                        System.out.println("╠══════════════════════════════════════════════════════════════════════════════════════════════════╣");
                        System.out.println("║                                                                                                  ║");
                        System.out.println("║"+centerString(97, padString(98, languageModule[28][selectedLanguage])+"║"));
                        System.out.println("║                                                                                                  ║");
                        System.out.println("╚══════════════════════════════════════════════════════════════════════════════════════════════════╝");
                        System.out.print(languageModule[81][selectedLanguage]);
                        input.nextLine();  
                ...
                for (int i = 0; i < arrayLayanan.length; i++) {
                    if (arrayLayanan[i][2] != arrayLayanan[i][3]) {
                        System.out.println("║ ["+i+"]. "+arrayLayanan[i][0]+" - "+arrayLayanan[i][1]+ " - Estimasi: "+arrayLayanan[i][2]+" - "+arrayLayanan[i][3]+ padString(32, languageModule[29][selectedLanguage]));
                    } else {
                        System.out.println("║ ["+i+"]. "+arrayLayanan[i][0]+" - "+arrayLayanan[i][1]+ " - Estimasi: "+arrayLayanan[i][2]+padString(32, languageModule[27][selectedLanguage]));
                    }
                }
                System.out.print (languageModule[80][selectedLanguage]);
                ...
                switch (metode) {
                    case 1:
                    System.out.println("║ "+padString(32, languageModule[32][selectedLanguage]));
                    ...
                    System.out.println("║ " +padString(32, languageModule[33][selectedLanguage]) +jenisBank);
                    break;

                    case 2: 
                    System.out.println("║ " +padString(32, languageModule[34][selectedLanguage]) +biayaAkhir+ padString(32, languageModule[35][selectedLanguage]));
                    break;

                    case 3:
                    System.out.println("║ " +padString(32, languageModule[36][selectedLanguage]) +biayaAkhir);
                    System.out.print("║ " +padString(32, languageModule[37][selectedLanguage]));
                    int bayar = input.nextInt();
                    System.out.println("║ " +padString(32, languageModule[38][selectedLanguage]) +(bayar - biayaAkhir));
                    break;
            ...
            displayIndonesianMap();
                ...
                while (!validInput) {
                    System.out.print("║ " +padString(32, languageModule[44][selectedLanguage]));
                    try {
                    ...
                    if (index != -1) {
                        ...
                        System.out.println("╠══════════════════════════════════════════════════════════════════════════════════════════════════╣");
                        System.out.println("║"+YELLOW+centerString(98,padString(32, languageModule[45][selectedLanguage]))+RESET);
                        System.out.println("╚══════════════════════════════════════════════════════════════════════════════════════════════════╝");
                    }
            ...
            displayIndonesianMap();
                ...
                if (deleteIndex >= 0 && deleteIndex < historyTransaksi.length) {
                    System.out.println("╠══════════════════════════════════════════════════════════════════════════════════════════════════╣");
                    System.out.println("║"+RED+centerString(98, padString(32, languageModule[47][selectedLanguage]))+RESET);
                    System.out.println("╚══════════════════════════════════════════════════════════════════════════════════════════════════╝");
